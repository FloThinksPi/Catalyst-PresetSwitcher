...
public class SimpleUpdater
{
   ...
   */
  public static void update(URL remoteLocation, File localDestination,
      ...
      throws IOException
  {
    ...
    updaterSection.putValue("Local-Name",
        localDestination.getName().toString());
    ...
    restartCommand.add(localDestination.getAbsolutePath().toString());
